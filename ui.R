shinyUI(fluidPage(
  titlePanel("Capstone Project For Prediction Of Words"),
  ...
  fluidRow(
    column(12,
           br(),
           h4("Predicted next word:", style = "color:green"), 
  ...
  fluidRow(
    column(12,
           br(),
           h6("Please click back in browser to go back to Presentation"),
           
           
           h6("Devloped By asn2905")
